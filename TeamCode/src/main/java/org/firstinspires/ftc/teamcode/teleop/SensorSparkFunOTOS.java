...
public class SensorSparkFunOTOS extends LinearOpMode {
    ...
    private void configureOtos() {
        ...
        SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(0, Constants.Y_OFFSET, 0);
        ...
        myOtos.setLinearScalar(Constants.L_SCALER);
        myOtos.setAngularScalar(Constants.A_SCALER);
