...
public class FollowerConstants {
    ...
    public static String leftFrontMotorName = HWValues.FRONT_LEFT;
    public static String leftRearMotorName = HWValues.BACK_LEFT;
    public static String rightFrontMotorName = HWValues.FRONT_RIGHT;
    public static String rightRearMotorName = HWValues.BACK_RIGHT;

    // This section is for setting the actual drive vector for the front left wheel, if the robot
    // is facing a heading of 0 radians with the wheel centered at (0,0)
    private static double xMovement = 78.851;
    private static double yMovement = 63.0931;
    ...
    public static double mass = RobotConstants.WEIGHT;
    ...
    public static double forwardZeroPowerAcceleration = -39.6477;

    // Acceleration of the drivetrain when power is cut in inches/second^2 (should be negative)
    // if not negative, then the robot thinks that its going to go faster under 0 power
    public static double lateralZeroPowerAcceleration = -76.788;
