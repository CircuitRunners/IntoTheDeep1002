...
public class OTOSLocalizer extends Localizer {
    ...
    public OTOSLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        otos.setOffset(new SparkFunOTOS.Pose2D(RobotConstants.PEDRO_X_OFFSET, RobotConstants.PEDRO_Y_OFFSET,Math.toRadians(RobotConstants.PEDRO_H_OFFSET)));

        // TODO: replace these with your tuned multipliers
        otos.setLinearScalar(RobotConstants.L_SCALER);
        otos.setAngularScalar(RobotConstants.A_SCALER);
